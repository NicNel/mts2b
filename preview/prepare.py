...
def preparePreview(previewFolder):
    ...
    #copy base files
    bsdfs_base = os.path.join(sceneDir, 'bsdfs_base.xml')
    geometry_base = os.path.join(sceneDir, 'geometry_base.xml')
    settings_base = os.path.join(sceneDir, 'settings_base.xml')
    
    shutil.copy2(bsdfs_base, previewFolder)
    shutil.copy2(geometry_base, previewFolder)
    shutil.copy2(settings_base, previewFolder)
